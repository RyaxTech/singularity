...
import (
	...
	"github.com/RyaxTech/singularity/internal/pkg/runtime/engine/singularity/rpc/client"
	...
	"github.com/RyaxTech/singularity/internal/pkg/util/fs/layout/layer/overlay"
	"github.com/RyaxTech/singularity/internal/pkg/util/fs/layout/layer/underlay"
	"github.com/RyaxTech/singularity/internal/pkg/util/fs/mount"
	fsoverlay "github.com/RyaxTech/singularity/internal/pkg/util/fs/overlay"
	...
	singularity "github.com/RyaxTech/singularity/pkg/runtime/engine/singularity/config"
	...
	if os.IsNotExist(err) {
		...
		if !bindMount && !remount {
			if mnt.Type == "devpts" {
				...
				// by default, see https://github.com/RyaxTech/singularity/issues/4539
...
func (c *container) addRootfsMount(system *mount.System) error {
	...
	case image.SANDBOX:
		...
		// and may lead to crash (see https://github.com/RyaxTech/singularity/issues/4851)
