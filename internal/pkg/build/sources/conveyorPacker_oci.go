...
import (
	...
	"github.com/RyaxTech/singularity/internal/pkg/build/oci"
	"github.com/RyaxTech/singularity/internal/pkg/util/shell"
	sytypes "github.com/RyaxTech/singularity/pkg/build/types"
...
func (cp *OCIConveyorPacker) Get(ctx context.Context, b *sytypes.Bundle) (err error) {
	...
	// https://github.com/RyaxTech/singularity/issues/5172
