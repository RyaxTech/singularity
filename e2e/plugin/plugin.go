...
func (c ctx) testPluginBasic(t *testing.T) {
	pluginName := "github.com/RyaxTech/singularity/e2e-plugin"
...
func (c ctx) testCLICallbacks(t *testing.T) {
	...
	pluginName := "github.com/RyaxTech/singularity/e2e-cli-plugin"
...
func (c ctx) testSingularityCallbacks(t *testing.T) {
	...
	pluginName := "github.com/RyaxTech/singularity/e2e-runtime-plugin"
