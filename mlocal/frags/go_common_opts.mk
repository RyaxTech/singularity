...
# https://github.com/RyaxTech/singularity/issues/5762
# Need to disable race detector on ppc64le
# https://github.com/RyaxTech/singularity/issues/5914
...
GO_GCFLAGS := -gcflags=github.com/RyaxTech/singularity/...="-trimpath $(SOURCEDIR)=>github.com/RyaxTech/singularity@v0.0.0"
GO_ASMFLAGS := -asmflags=github.com/RyaxTech/singularity/...="-trimpath $(SOURCEDIR)=>github.com/RyaxTech/singularity@v0.0.0"
